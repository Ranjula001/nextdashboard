  ...
  try {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Cancelled Bookings</h1>
            <p className="text-slate-600 mt-2">View all cancelled bookings</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          {cancelledBookings.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-slate-900 mb-2">No Cancelled Bookings</h2>
              <p className="text-slate-600">Cancelled bookings will appear here</p>
            </div>
          )}
        </div>
      </div>
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 mt-2">Failed to load cancelled bookings</p>
      </div>
    );
  }
}